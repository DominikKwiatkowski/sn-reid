...
from torchreid.losses import TripletLoss, CentroidTripletLoss

from ..engine import Engine


class ImageCentroidEngine(Engine):
    r"""Centroid engine for image-reid.
    ...
    def __init__(
        ...
        super(ImageCentroidEngine, self).__init__(datamanager, use_gpu)
        ...
        self.criterion_x = CentroidTripletLoss(margin=margin
        )
